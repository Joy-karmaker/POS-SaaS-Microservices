...
Object.defineProperty(exports, "InventorySaleConsumer", {
    enumerable: true,
    get: function() {
        return InventorySaleConsumer;
    }
});
...
let InventorySaleConsumer = class InventorySaleConsumer {
    async onModuleInit() {
        try {
    ...
    constructor(tenant, inventory){
        this.tenant = tenant;
        this.inventory = inventory;
        this.logger = new _common.Logger(InventorySaleConsumer.name);
        ...
        this.queue = 'inventory.sale.completed';
        this.routingKey = 'sale.completed';
        this.consumer = 'inventory.sale.completed';
    }
};
InventorySaleConsumer = _ts_decorate([
...
], InventorySaleConsumer);

//# sourceMappingURL=inventory-sale.consumer.js.map